...
function getJsonObject(callbackfunction,url,data){
	...
	serviceURL = window.location.protocol+"//"+window.location.hostname+":"+port_api+"/";
	_ajax_request(serviceURL + url, {"data":data}, callbackfunction, 'json', 'POST');
}

function getJsonObjectSync(callbackfunction,url,data){

	serviceURL = window.location.protocol+"//"+window.location.hostname+":"+port_api+"/";
	_ajax_request_sync(serviceURL + url, {"data":data}, callbackfunction, 'json', 'POST');
}
...
function _ajax_request_sync(url, data, callback, type, method)
