...
var reqarray=[	{name:'request',require:'request'},
	            ...
	            {name:'request_action_appli_camping',require:'./serveur_api/request_action_appli_camping'},
...
var app = function(){
	...
	this.config= require('./config_app_camping.json');
